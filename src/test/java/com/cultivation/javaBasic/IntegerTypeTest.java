...
class IntegerTypeTest {
    ...
    void should_truncate_number_when_casting() {
        ...
        // TODO: please modify the following lines to pass the test
        // <!--start
        final short expected = new Integer(integer).shortValue();
        // --end-->
    ...
    void should_increment() {
        ...
        // <--start
        final int expectedCurrentInteger = Math.incrementExact(result);
        final int expectedResult = Math.decrementExact(expectedCurrentInteger);
        // --end-->
    ...
    void should_increment_2() {
        ...
        // TODO: please modify the following code to pass the test
        // <--start
        final int expectedCurrentInteger = Math.incrementExact(3);
        final int expectedResult = Math.incrementExact(3);
        // --end-->
